...
def draw_cities_and_routes(city_locations, routes):
    ''' draw cities '''
    for city in city_locations:
        pygame.draw.circle(pygame_surface, black, city, 3, 0)

    ''' draw first 10 routes '''
    for route in routes:
        pygame.draw.line(pygame_surface, black, route[0], route[1], 1)
...
if __name__ == "__main__":
    ...
    while True:
        ...
        draw_cities_and_routes(city_locations, routes)
